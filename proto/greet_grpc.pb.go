...
type GreetServiceClient interface {
	...
	SayHelloBidirectionaStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionaStreamingClient, error)
}
...
func (c *greetServiceClient) SayHelloBidirectionaStreaming(ctx context.Context, opts ...grpc.CallOption) (GreetService_SayHelloBidirectionaStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet_service.GreetService/SayHelloBidirectionaStreaming", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloBidirectionaStreamingClient{stream}
	return x, nil
}

type GreetService_SayHelloBidirectionaStreamingClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloBidirectionaStreamingClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloBidirectionaStreamingClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionaStreamingClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	...
	SayHelloBidirectionaStreaming(GreetService_SayHelloBidirectionaStreamingServer) error
...
func (UnimplementedGreetServiceServer) SayHelloBidirectionaStreaming(GreetService_SayHelloBidirectionaStreamingServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBidirectionaStreaming not implemented")
}
...
func _GreetService_SayHelloBidirectionaStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidirectionaStreaming(&greetServiceSayHelloBidirectionaStreamingServer{stream})
}

type GreetService_SayHelloBidirectionaStreamingServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type greetServiceSayHelloBidirectionaStreamingServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloBidirectionaStreamingServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionaStreamingServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBidirectionaStreaming",
			Handler:       _GreetService_SayHelloBidirectionaStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
